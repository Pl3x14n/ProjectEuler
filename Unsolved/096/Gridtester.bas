...
SUB sudoku_solver(s$)
   local row , gap , i , r , g , LINE , startmiss , miss
    
   SET bitmap SIZE 400 , 400
   SET WINDOW 0.5,9.5,0.5,9.5
    
   SET TEXT JUSTIFY "Center" , "Half"
   SET TEXT ANGLE 0
   SET TEXT font "Segoe Print" , 25
   SET COLOR MIX (50) 1,0.7,0    ! Farbe der dicken Linien
   SET COLOR MIX (51) 1,0.7,0    ! Farbe der dünnen Linien
   SET COLOR MIX (52) 1,0.9,0    ! Farbe der Kästchen
   ...
   FOR i = 1 TO 81
      ...
      IF g = 10 THEN
         ...
         LET r = r + 1
      END IF 
      LET grid(r,g) = VAL(s$(i:i))
      IF grid(r,g) <> 0 THEN PLOT AREA : g-0.5,10.5-r ; g-0.5,9.5-r ; g+0.5,9.5-r ; g+0.5,10.5-r
   NEXT i 
...
SUB anzeige
   ...
   FOR LINE = 0.5 TO 9.5
      ...
      ELSE
         ...
         SET LINE COLOR 51
      END IF
      PLOT LINES : LINE,0 ; LINE,10
      PLOT LINES : 0,LINE ; 10,LINE
   NEXT LINE
...
SUB new_number(r,g,m)
   ...
   REM   - ... wird die Zahl hingeschrieben
   ...
   PLOT TEXT , AT g,10-r : STR$(grid(r,g) )
